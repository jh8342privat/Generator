...
def main():
    ...
    if heading:
        ...
        auswertung1 = {'title': 'CDU/CSU verbündet sich mit Rechtsextremen, um Klimaschutz in Europa zu verhindern. Das Eilverfahren zu den 2040 Klimazielen wurde heute abgelehnt', 'ja': [{'name': 'Barley', 'vorname': 'Katarina', 'partei': 'SPD'}, {'name': 'Bischoff', 'vorname': 'Gabriele', 'partei': 'SPD'}, {'name': 'Bullmann', 'vorname': 'Udo', 'partei': 'SPD'}, {'name': 'Costanzo', 'vorname': 'Vivien', 'partei': 'SPD'}, {'name': 'Cremer', 'vorname': 'Tobias', 'partei': 'SPD'}, {'name': 'Ecke', 'vorname': 'Matthias', 'partei': 'SPD'}, {'name': 'Geier', 'vorname': 'Jens', 'partei': 'SPD'}, {'name': 'Lange', 'vorname': 'Bernd', 'partei': 'SPD'}, {'name': 'Noichl', 'vorname': 'Maria', 'partei': 'SPD'}, {'name': 'Repasi', 'vorname': 'René', 'partei': 'SPD'}, {'name': 'Repp', 'vorname': 'Sabrina', 'partei': 'SPD'}, {'name': 'Sippel', 'vorname': 'Birgit', 'partei': 'SPD'}, {'name': 'Wölken', 'vorname': 'Tiemo', 'partei': 'SPD'}, {'name': 'Andresen', 'vorname': 'Rasmus', 'partei': 'Grune'}, {'name': 'Bloss', 'vorname': 'Michael', 'partei': 'Grune'}, {'name': 'Cavazzini', 'vorname': 'Anna', 'partei': 'Grune'}, {'name': 'Freund', 'vorname': 'Daniel', 'partei': 'Grune'}, {'name': 'Geese', 'vorname': 'Alexandra', 'partei': 'Grune'}, {'name': 'Häusling', 'vorname': 'Martin', 'partei': 'Grune'}, {'name': 'Lagodinsky', 'vorname': 'Sergey', 'partei': 'Grune'}, {'name': 'Marquardt', 'vorname': 'Erik', 'partei': 'Grune'}, {'name': 'Neumann', 'vorname': 'Hannah', 'partei': 'Grune'}, {'name': 'Paulus', 'vorname': 'Jutta', 'partei': 'Grune'}, {'name': 'Reintke', 'vorname': 'Terry', 'partei': 'Grune'}, {'name': 'Demirel', 'vorname': 'Özlem', 'partei': 'Linke'}, {'name': 'Rackete', 'vorname': 'Carola', 'partei': 'Linke'}, {'name': 'Schirdewan', 'vorname': 'Martin', 'partei': 'Linke'}, {'name': 'Singer', 'vorname': 'Christine', 'partei': 'fw'}, {'name': 'De Masi', 'vorname': 'Fabio', 'partei': 'BSW'}, {'name': 'Firmenich', 'vorname': 'Ruth', 'partei': 'BSW'}, {'name': 'Geisel', 'vorname': 'Thomas', 'partei': 'BSW'}, {'name': 'Von Der Schulenburg', 'vorname': 'Michael', 'partei': 'BSW'}, {'name': 'Warnke', 'vorname': 'Jan-peter', 'partei': 'BSW'}, {'name': 'Ripa', 'vorname': 'Manuela', 'partei': 'ODP'}, {'name': 'Boeselager', 'vorname': 'Damian', 'partei': 'Volt'}, {'name': 'Riehl', 'vorname': 'Nela', 'partei': 'Volt'}, {'name': 'Tegethoff', 'vorname': 'Kai', 'partei': 'Volt'}, {'name': 'Berg', 'vorname': 'Sibylle', 'partei': 'Die Partei'}, {'name': 'Sonneborn', 'vorname': 'Martin', 'partei': 'Die Partei'}, {'name': 'Everding', 'vorname': 'Sebastian', 'partei': 'Tierschutz'}, {'name': 'Sieper', 'vorname': 'Lukas', 'partei': 'PDF'}], 'nein': [{'name': 'Bentele', 'vorname': 'Hildegard', 'partei': 'CDU'}, {'name': 'Berger', 'vorname': 'Stefan', 'partei': 'CDU'}, {'name': 'Caspary', 'vorname': 'Daniel', 'partei': 'CDU'}, {'name': 'Düpont', 'vorname': 'Lena', 'partei': 'CDU'}, {'name': 'Ehler', 'vorname': 'Christian', 'partei': 'CDU'}, {'name': 'Gahler', 'vorname': 'Michael', 'partei': 'CDU'}, {'name': 'Gieseke', 'vorname': 'Jens', 'partei': 'CDU'}, {'name': 'Herbst', 'vorname': 'Niclas', 'partei': 'CDU'}, {'name': 'Liese', 'vorname': 'Peter', 'partei': 'CDU'}, {'name': 'Lins', 'vorname': 'Norbert', 'partei': 'CDU'}, {'name': 'Mcallister', 'vorname': 'David', 'partei': 'CDU'}, {'name': 'Mehnert', 'vorname': 'Alexandra', 'partei': 'CDU'}, {'name': 'Mertens', 'vorname': 'Verena', 'partei': 'CDU'}, {'name': 'Radtke', 'vorname': 'Dennis', 'partei': 'CDU'}, {'name': 'Schenk', 'vorname': 'Oliver', 'partei': 'CDU'}, {'name': 'Schneider', 'vorname': 'Christine', 'partei': 'CDU'}, {'name': 'Schwab', 'vorname': 'Andreas', 'partei': 'CDU'}, {'name': 'Seekatz', 'vorname': 'Ralf', 'partei': 'CDU'}, {'name': 'Simon', 'vorname': 'Sven', 'partei': 'CDU'}, {'name': 'Verheyen', 'vorname': 'Sabine', 'partei': 'CDU'}, {'name': 'Voss', 'vorname': 'Axel', 'partei': 'CDU'}, {'name': 'Walsmann', 'vorname': 'Marion', 'partei': 'CDU'}, {'name': 'Wechsler', 'vorname': 'Andrea', 'partei': 'CDU'}, {'name': 'Doleschal', 'vorname': 'Christian', 'partei': 'CSU'}, {'name': 'Ferber', 'vorname': 'Markus', 'partei': 'CSU'}, {'name': 'Hohlmeier', 'vorname': 'Monika', 'partei': 'CSU'}, {'name': 'Köhler', 'vorname': 'Stefan', 'partei': 'CSU'}, {'name': 'Niebler', 'vorname': 'Angelika', 'partei': 'CSU'}, {'name': 'Weber', 'vorname': 'Manfred', 'partei': 'CSU'}, {'name': 'Anderson', 'vorname': 'Christine', 'partei': 'AfD'}, {'name': 'Arndt', 'vorname': 'Anja', 'partei': 'AfD'}, {'name': 'Aust', 'vorname': 'René', 'partei': 'AfD'}, {'name': 'Bausemer', 'vorname': 'Arno', 'partei': 'AfD'}, {'name': 'Boßdorf', 'vorname': 'Irmhild', 'partei': 'AfD'}, {'name': 'Buchheit', 'vorname': 'Markus', 'partei': 'AfD'}, {'name': 'Bystron', 'vorname': 'Petr', 'partei': 'AfD'}, {'name': 'Droese', 'vorname': 'Siegbert Frank', 'partei': 'AfD'}, {'name': 'Froelich', 'vorname': 'Tomasz', 'partei': 'AfD'}, {'name': 'Jongen', 'vorname': 'Marc', 'partei': 'AfD'}, {'name': 'Jungbluth', 'vorname': 'Alexander', 'partei': 'AfD'}, {'name': 'Khan', 'vorname': 'Mary', 'partei': 'AfD'}, {'name': 'Neuhoff', 'vorname': 'Hans', 'partei': 'AfD'}, {'name': 'Schnurrbusch', 'vorname': 'Volker', 'partei': 'AfD'}, {'name': 'Sell', 'vorname': 'Alexander', 'partei': 'AfD'}, {'name': 'Eroglu', 'vorname': 'Engin', 'partei': 'fw'}, {'name': 'Geuking', 'vorname': 'Niels', 'partei': 'Familien Partei'}, {'name': 'Pürner', 'vorname': 'Friedrich', 'partei': 'Independent'},], 'enthaltung': [{'name': 'Glück', 'vorname': 'Andreas', 'partei': 'FDP'}, {'name': 'Hahn', 'vorname': 'Svenja', 'partei': 'FDP'}, {'name': 'Körner', 'vorname': 'Moritz', 'partei': 'FDP'}, {'name': 'Oetjen', 'vorname': 'Jan-christoph', 'partei': 'FDP'}, {'name': 'Strack-Zimmermann', 'vorname': 'Marie-agnes', 'partei': 'FDP'}], 'nicht_abgestimmt': [{'name': 'Burkhardt', 'vorname': 'Delara', 'partei': 'SPD'}, {'name': 'Langensiepen', 'vorname': 'Katrin', 'partei': 'Grune'}, {'name': 'Streit', 'vorname': 'Joachim', 'partei': 'fw'}]}
        generate_image(auswertung1)
